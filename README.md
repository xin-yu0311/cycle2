...
#Final Conclusion
The analysis showed that 29.996% of adolescents reported feeling depressed 
or hopeless, which is nearly equal to the expected 0.30. The p-value (0.9926) 
and the 95% confidence interval both indicate no significant difference from 
the target.
